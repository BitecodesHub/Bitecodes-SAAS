...
export const projectTypes = [
  ...
  { value: "ecommerce", label: "eCommerce store", base: 225_000, weeks: 8 },
  {
    value: "web-app",
  ...
  { value: "saas-mvp", label: "SaaS or startup MVP", base: 700_000, weeks: 16 },
  {
    value: "mobile-app",
...
export const estimatorFeatures = [
  ...
  { value: "admin", label: "Admin dashboard", cost: 160_000, weeks: 3 },
  {
    value: "integrations",
  ...
  { value: "realtime", label: "Real-time features", cost: 150_000, weeks: 3 },
  { value: "ai", label: "AI-powered workflow", cost: 175_000, weeks: 3 },
  { value: "migration", label: "Data migration", cost: 100_000, weeks: 2 },
] as const;
